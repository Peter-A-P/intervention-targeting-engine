...
- [ ] Repository public, v0.1.0 tagged (prepared 2026-09-18: MIT `LICENSE` committed,
      version 0.1.0 in `pyproject.toml` and `itx.__version__`, a licence section in the
      README, repository topics and homepage set, and `tests/test_release.py` keeping
      those claims in step with each other. The flip and the tag are Peter's to make)
